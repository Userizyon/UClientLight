...
namespace UClient.Bindings
{
    ...
    {
        internal static IULibBindings AutoDetectBindings()
        {
            ...
            throw new PlatformNotSupportedException($"Current platform is not supported by TDLib. Please pass your own instance of {typeof(IULibBindings).FullName} to a constructor of {typeof(UserizyonLightClient).FullName} or {typeof(UJsonClient).FullName}.");
        }
