...
public int VolumeLevel { get; set; }
        ...
        public static Task<Ok> SetGroupCallParticipantVolumeLevelAsync(
            this Client client, int groupCallId = default, MessageSender participant = default, int volumeLevel = default)
        {
            return client.ExecuteAsync(new SetGroupCallParticipantVolumeLevel
            {
                GroupCallId = groupCallId, Participant = participant, VolumeLevel = volumeLevel
            });
        }
    }
}
