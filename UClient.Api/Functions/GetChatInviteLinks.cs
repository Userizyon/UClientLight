...
public int Limit { get; set; }
        ...
        public static Task<ChatInviteLinks> GetChatInviteLinksAsync(
            this Client client, long chatId = default, int creatorUserId = default, bool isRevoked = default, int offsetDate = default, string offsetInviteLink = default, int limit = default)
        {
