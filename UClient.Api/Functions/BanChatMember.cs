...
public bool RevokeMessages { get; set; }
        ...
        public static Task<Ok> BanChatMemberAsync(
            this Client client, long chatId = default, int userId = default, int bannedUntilDate = default, bool revokeMessages = default)
        {
            return client.ExecuteAsync(new BanChatMember
            {
                ChatId = chatId, UserId = userId, BannedUntilDate = bannedUntilDate, RevokeMessages = revokeMessages
            });
        }
    }
}
