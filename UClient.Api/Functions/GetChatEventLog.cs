...
public int[] UserIds { get; set; }
        ...
        public static Task<ChatEvents> GetChatEventLogAsync(
            this Client client, long chatId = default, string query = default, long fromEventId = default, int limit = default, ChatEventLogFilters filters = default, int[] userIds = default)
        {
