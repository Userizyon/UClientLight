...
public long MessageThreadId { get; set; }
        ...
        public static Task<Messages> SearchChatMessagesAsync(
            this Client client, long chatId = default, string query = default, MessageSender sender = default, long fromMessageId = default, int offset = default, int limit = default, SearchMessagesFilter filter = default, long messageThreadId = default)
        {
            return client.ExecuteAsync(new SearchChatMessages
            {
                ChatId = chatId, Query = query, Sender = sender, FromMessageId = fromMessageId, Offset = offset, Limit = limit, Filter = filter, MessageThreadId = messageThreadId
            });
        }
    }
}
